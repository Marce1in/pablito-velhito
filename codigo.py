        ...
        for i in range(len(caminho)):
            ...
            if fator > 1:
                if valor < no.esquerda.valor:
                    #  LL
                    nova_sub_raiz = self.rotacao_a_direta(no)

                elif valor > no.esquerda.valor:
                    # LR
                    no.esquerda = self.rotacao_a_esquerda(no.esquerda)
                    nova_sub_raiz = self.rotacao_a_direta(no)
            ...
            if fator < -1:
                ...
                if valor > no.direita.valor:
                    # RR
                    nova_sub_raiz = self.rotacao_a_esquerda(no)

                elif valor < no.direita.valor:
                    # RL
                    no.direita = self.rotacao_a_direta(no.direita)
                    nova_sub_raiz = self.rotacao_a_esquerda(no)
